...
{{
var G__17967 = cljs.core.pop.call(null,v__$1);
v__$1 = G__17967;
continue;
}
} else
...
{var pred__17971 = cljs.core._EQ_;var expr__17972 = limit;if(cljs.core.truth_(pred__17971.call(null,1,expr__17972)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__17971.call(null,2,expr__17972)))
...
var G__17974 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__17975 = (limit__$1 - 1);
var G__17976 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__17974;
limit__$1 = G__17975;
parts = G__17976;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___17978 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___17978))
{var replacement_17979 = temp__4124__auto___17978;buffer.append([cljs.core.str(replacement_17979)].join(''));
} else
{buffer.append(ch);
}
{
var G__17980 = (index + 1);
index = G__17980;
continue;
}
}
