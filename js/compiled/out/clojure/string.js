...
{{
var G__13804 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13804;
continue;
}
} else
...
{var pred__13808 = cljs.core._EQ_;var expr__13809 = limit;if(cljs.core.truth_(pred__13808.call(null,1,expr__13809)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__13808.call(null,2,expr__13809)))
...
var G__13811 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__13812 = (limit__$1 - 1);
var G__13813 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__13811;
limit__$1 = G__13812;
parts = G__13813;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___13815 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___13815))
{var replacement_13816 = temp__4124__auto___13815;buffer.append([cljs.core.str(replacement_13816)].join(''));
} else
{buffer.append(ch);
}
{
var G__13817 = (index + 1);
index = G__13817;
continue;
}
}
