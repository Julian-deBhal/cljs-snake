...
{{
var G__13880 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13880;
continue;
}
} else
...
{var pred__13884 = cljs.core._EQ_;var expr__13885 = limit;if(cljs.core.truth_(pred__13884.call(null,1,expr__13885)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__13884.call(null,2,expr__13885)))
...
var G__13887 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__13888 = (limit__$1 - 1);
var G__13889 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__13887;
limit__$1 = G__13888;
parts = G__13889;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___13891 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___13891))
{var replacement_13892 = temp__4124__auto___13891;buffer.append([cljs.core.str(replacement_13892)].join(''));
} else
{buffer.append(ch);
}
{
var G__13893 = (index + 1);
index = G__13893;
continue;
}
}
