...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_17755 = 0;while(true){
if((i_17755 < arr.length))
{(arr[i_17755] = null);
{
var G__17756 = (i_17755 + 1);
i_17755 = G__17756;
continue;
}
} else
...
{var i_17762 = (self__.level + 1);while(true){
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_17764 = 0;while(true){
if((i_17764 <= self__.level))
{var links_17765 = (update[i_17764]).forward;if(((links_17765[i_17764]) === x__$1))
